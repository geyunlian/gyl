...
<body>
    ...
    try{
    	...
    	String sql = "SELECT dname FROM doctor WHERE dtel=? AND dpwd=?";
    	pstmt = conn.prepareStatement(sql);
    	pstmt.setString(1,request.getParameter("dtel"));
    	pstmt.setString(2,request.getParameter("dpwd"));
    ...
    if(flag){
    %>
    <jsp:forward page="Doctorlogin_success.jsp">
